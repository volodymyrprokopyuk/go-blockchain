...
*** Testing the genesis creation on the bootstrap node
*** Testing the genesis fetching from the bootstrap node
*** Testing reading confirmed blocks from the local block store
*** Testing fetching confirmed blocks from all known peers
