...
The gRPC =TxSign= method is exposed through the CLI. The parameters to create
...
To create and sign a new transaction run the following commands in a terminal
...
- Create and sign a new transaction
  #+BEGIN_SRC fish
set -g sender d54173365ca6c47d482b0a06ba4f196049014145093778427383de19d66a76d7
./bcn tx sign --node $node --from $sender --to recipient --value 12 \
  --ownerpass $ownerpass
  #+END_SRC
  Structure of the signed transaction
  #+BEGIN_SRC json
{
  ...
  "value":12,
  "nonce":1,
  "time":"2024-09-29T09:57:28.65978649+02:00", "sig":"Cz+qV8DaD+sCnaLnTR2S49a/9nwsYbe2EF8Y6Upa/vYoGY7P9qSmzDSBBHQolg6KdxIiS/NrXvcevLiSYJpbvQE="
}
  #+END_SRC
